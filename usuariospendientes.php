        ...
        <section class="content">
        	...
        	<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Lista usuarios pendientes</h3>
                </div><!-- /.box-header -->
                    ...
                    <tbody>
                      ...
                      if ($res){
                      	foreach($res as $r){
                            ...
                            <td>'.$r['email'].'</td>
                           <td>
                              <form action="validarusuario.php" method="POST" style="display:inline">
                               <button type="submit" class="btn btn-primary" title="Usuario '.$r['id'].'">Validar</button>
                               <input type="hidden" name="idusuario" value="'.$r['id'].'">
                              </form>
							  <form action="borrarusuario.php" method="POST" style="display:inline">
                               <button type="submit" class="btn btn-danger" title="Usuario '.$r['id'].'">Borrar</button>
                               <input type="hidden" name="idusuario" value="'.$r['id'].'">
                              </form>
